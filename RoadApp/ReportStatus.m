...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    UIView *sectionView=[[UIView alloc]initWithFrame:CGRectMake(0, 0, 280,20)];
    ...
    UIView* separatorLineView = [[UIView alloc] initWithFrame:CGRectMake(15, 20, _expandableTableView.frame.size.width-15, 1)];
    separatorLineView.backgroundColor = [UIColor blackColor];
